    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        barcodeScannerView.setTorchListener(new DecoratedBarcodeView.TorchListener() {
            ...
            public void onTorchOn() {
                buttonLed.setBackground(getResources().getDrawable(R.drawable.btn_nav_user_press));
                bTorch = true;
            }

            @Override
            public void onTorchOff() {
                buttonLed.setBackground(getResources().getDrawable(R.drawable.btn_nav_user_normal));
                bTorch = false;
            }
        });
